...
set nf [open out_cen3.nam w]
$ns namtrace-all $nf

set nf2 [open out_cen3.tr w]
$ns trace-all $nf2

set f0 [open out_cen3FTP-bw.tr w]
set f1 [open out_cen3CBR1-bw.tr w]
set f2 [open out_cen3CBR2-bw.tr w]
...
proc finish {} {
        ...
        close $nf
        exec nam out_cen3 &
	exec xgraph out_cen3FTP-bw.tr out_cen3CBR1-bw.tr out_cen3CBR2-bw.tr &
        exit 0
}
proc record {} {
...
$ns duplex-link $n1 $n2 1Mb 20ms RED
